...
import com.ibwhtd.springboot.domain.posts.Posts;
import com.ibwhtd.springboot.domain.posts.PostsRepository;
...
public class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        Long IdToUpdate = savedPost.getId();
        ...
        String url = "http://localhost:" + port + "/api/v1/posts/" + IdToUpdate;
